...
/*
    ...
    incase of let variable it not get shadow , block variable store in block scope(also can see in insepect sourse debugger scope )
    we can shadow var variable in global scope in to block scope - 
    let a = 10; { var a = 100; } - this occures error, BUT var a = 10; { let a = 100; } - this wont get any error but  because block scope also follow lexical scope (hierarchy) and let variable can not redeclare 
*/
    ...
    let e = 5000; // this will not get shadow by block let e variable 
        ...
        console.log('outside block d : ', d); //40 - must be 4000 but shadow by d present by d variable present in block 
